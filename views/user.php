      ...
      <div class="container is-fluid">
        <br>
          ...
          <div class="nav-buttons">
              ...
              <button onclick="window.location.href='ingresoArea.php'" class="btn btn-success">Ingresos Areas</button>
              <button onclick="window.location.href='registro.php'" class="btn btn-success">Registro</button>
